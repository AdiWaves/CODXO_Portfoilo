...
export const ProjectList = [
  {
    ...
    title: "Bicycle Rental Management System",
    description:
      "A platform for management of bicycle rental and maintainence.",
    tech_stack: ["HTML", "CSS", "JS", "SQL"],
    github_url: "",
  ...
  },
  {
    ...
    description:
      "A system for garages to maintain inventory and track work progress in workshop",
